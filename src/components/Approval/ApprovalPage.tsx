...
import { Check, X, CreditCard as Edit2, Facebook, Instagram, Calendar, Eye } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-green-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Post Aprovado!</h1>
          <p className="text-gray-600">Este post já foi aprovado e será publicado na data agendada.</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-red-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Post Rejeitado</h1>
          <p className="text-gray-600">Este post foi rejeitado e não será publicado.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
            ...
            <p className="text-blue-100 text-sm mt-1">Revise e aprove o conteúdo abaixo</p>
          </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between py-2">
                      <span className="text-sm font-medium text-gray-600">Data de Publicação:</span>
                      <div className="flex items-center space-x-1">
                        <Calendar size={14} className="text-gray-400" />
                        <span className="text-sm text-gray-900">{formatDate(post.scheduledDate)}</span>
                      </div>
                    </div>
                  </div>
                </div>
